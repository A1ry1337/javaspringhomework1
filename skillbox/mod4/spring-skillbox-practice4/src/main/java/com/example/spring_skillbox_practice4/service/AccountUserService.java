...
import com.example.spring_skillbox_practice4.exception.UserNotFoundException;
import com.example.spring_skillbox_practice4.mapper.AccountUserMapper;
...
public class AccountUserService {
    ...
    public AccountUserDTO createUser(AccountUserDTO accountUserDTO) {
        try {
            AccountUser user = accountUserMapper.toEntity(accountUserDTO);
